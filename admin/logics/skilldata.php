...
if (isset(($_POST['submit-btn']))) {
    ...
    if (mysqli_query($connection, $query)) {
        header("Location: http://localhost/PakFixer/admin/pages/add_skill_card.php?card=yes");
    } else {
        header("Location: http://localhost/PakFixer/admin/pages/add_skill_card.php?card=no");
    }
